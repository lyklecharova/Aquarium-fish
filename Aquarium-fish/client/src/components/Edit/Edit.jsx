...
export const Edit = () => {
    ...
    const handleImageChange = (e) => {
        ...
        if (file) {
            ...
            // Използваме onload събитието, което се извиква, когато операцията на
    ...
    return (
        <div className={style['container']}>
            <form onSubmit={handleEditSubmit} className={style['edit-form']} method="post">
                ...
                <button type="submit" className={style['edit-button']}>Edit</button>
